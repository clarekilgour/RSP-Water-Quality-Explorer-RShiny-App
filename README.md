...
<h2>About</h2>
<p>
The code for this RShiny app was written by <a href="https://github.com/p-schaefer" target="_blank">Patrick Schaefer</a> (<a href="https://datastream.org/" target="_blank">DataStream</a>) and Clare Kilgour (UBC / Azimuth Consulting Group Inc.), and was developed as part of the <a href = "https://www.theroadsaltproject.com" target="_blank">Road Salt Project</a> (NSERC Alliance).
